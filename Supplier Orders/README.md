...
This folder defines all source code for the 'Supplier Orders' pipeline:
...
* Take a look at the sample under "sample_users_supplier_orders.py" to get familiar with the syntax.
