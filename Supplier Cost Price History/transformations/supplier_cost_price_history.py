...
# 1️⃣ Paths
# =========================================================
supplier_pricehistory_path = dbutils.secrets.get(scope='rsmas-dev-scope', key='master-data-path')+ "product/supplier_costprice_updates/"

# =========================================================
# 2️⃣ Bronze Layer – Raw Product Price Updates
# =========================================================
@dlt.table(
    name="rsmas_catalog.rsmas_productmaster_schema.supplier_costprice_updates",
...
try:
    dlt.create_target_table(
        name="rsmas_catalog.rsmas_productmaster_schema.supplier_costprice_history",
...
# =========================================================
dlt.apply_changes(
    target="rsmas_catalog.rsmas_productmaster_schema.supplier_costprice_history",
    source="rsmas_catalog.rsmas_productmaster_schema.supplier_costprice_updates",
